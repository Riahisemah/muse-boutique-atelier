...
export const CATEGORIES: Category[] = [
  {
    slug: "soiree",
    name: { fr: "Robes de soirée", ar: "فساتين سهرة", it: "Abiti da sera" },
    image: dress1,
  },
  {
    slug: "ceremonie",
    name: { fr: "Robes de cérémonie", ar: "فساتين مناسبات", it: "Abiti da cerimonia" },
    image: dress3,
  },
  {
    slug: "casual",
    name: { fr: "Robes casual", ar: "فساتين يومية", it: "Abiti casual" },
    image: dress4,
  },
  {
    slug: "elegantes",
    name: { fr: "Robes élégantes", ar: "فساتين أنيقة", it: "Abiti eleganti" },
    image: dress2,
  },
  {
    slug: "nouvelles-collections",
    name: { fr: "Nouvelles collections", ar: "المجموعات الجديدة", it: "Nuove collezioni" },
    image: dress6,
  },
  {
    slug: "best-sellers",
    name: { fr: "Best-sellers", ar: "الأكثر مبيعاً", it: "Best seller" },
    image: dress5,
  },
];

export const COLLECTIONS: Collection[] = [
  { slug: "atelier-noir", name: { fr: "Atelier Noir", ar: "أتيليه نوار", it: "Atelier Noir" } },
  { slug: "lumiere", name: { fr: "Lumière", ar: "لوميير", it: "Lumière" } },
  { slug: "riviera", name: { fr: "Riviera", ar: "ريفييرا", it: "Riviera" } },
  { slug: "heritage", name: { fr: "Héritage", ar: "هيريتاج", it: "Heritage" } },
];

const COLORS = {
  black: { id: "black", name: { fr: "Noir", ar: "أسود", it: "Nero" }, hex: "#171412" },
  ivory: { id: "ivory", name: { fr: "Ivoire", ar: "عاجي", it: "Avorio" }, hex: "#F6F1E6" },
  nude: { id: "nude", name: { fr: "Nude", ar: "بيج فاتح", it: "Nude" }, hex: "#E3C8AE" },
  beige: { id: "beige", name: { fr: "Beige", ar: "بيج", it: "Beige" }, hex: "#D9C3A5" },
  gold: { id: "gold", name: { fr: "Doré", ar: "ذهبي", it: "Oro" }, hex: "#C9A96A" },
  olive: { id: "olive", name: { fr: "Olive", ar: "زيتوني", it: "Oliva" }, hex: "#5A5A33" },
};

function details(fabricFr: string, fabricAr: string, fabricIt: string) {
  return {
    composition: {
    ...
    fabric: { fr: fabricFr, ar: fabricAr, it: fabricIt },
    fit: {
...
function sizes(s: number, m: number, l: number, xl: number) {
  return [
    { size: "S", stock: s },
    { size: "M", stock: m },
    { size: "L", stock: l },
...
export const PRODUCTS: Product[] = [
  {
    ...
    sku: "MN-SOI-001",
    name: { fr: "Robe Nocturne", ar: "فستان نوكتورن", it: "Abito Nocturne" },
    description: {
  ...
  },
  {
    ...
    sku: "MN-ELE-002",
    name: { fr: "Robe Lumière", ar: "فستان لوميير", it: "Abito Lumière" },
    description: {
  ...
  },
  {
    ...
    sku: "MN-CER-003",
    name: { fr: "Robe Plissé Ivoire", ar: "فستان بليسيه عاجي", it: "Abito Plissé Avorio" },
    description: {
  ...
  },
  {
    ...
    sku: "MN-CAS-004",
    name: { fr: "Robe Riviera", ar: "فستان ريفييرا", it: "Abito Riviera" },
    description: {
  ...
  },
  {
    ...
    sku: "MN-ELE-005",
    name: { fr: "Robe Portefeuille Olive", ar: "فستان لفّة زيتوني", it: "Abito a Portafoglio Oliva" },
    description: {
  ...
  },
  {
    ...
    sku: "MN-SOI-006",
    name: { fr: "Robe Étoile", ar: "فستان إتوال", it: "Abito Étoile" },
    description: {
  ...
  },
  {
    ...
    sku: "MN-CER-007",
    name: { fr: "Robe Carthage", ar: "فستان قرطاج", it: "Abito Cartagine" },
    description: {
  ...
  },
  {
    ...
    sku: "MN-CAS-008",
    name: { fr: "Robe Médina", ar: "فستان المدينة", it: "Abito Medina" },
    description: {
